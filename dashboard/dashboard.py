...
# change to datetime data type, and order all_df by order date
...
with st.sidebar:
    ...
    # pick start and end date from date_input to make filter
...
with col1:
    ...
    sns.barplot(y="customer_count", x="gender", data=bygender_df.sort_values(by="customer_count", ascending=False), palette=colors, ax=ax)
...
with col2:
    ...
    sns.barplot(y="customer_count", x="age_group", data=byage_df.sort_values(by="customer_count", ascending=False), palette=colors, ax=ax)
...
sns.barplot(x="customer_count", y="state", data=bystate_df.sort_values(by="customer_count", ascending=False), palette=colors, ax=ax)
...
st.caption("Copyright (c) Dicoding Collection 2023")